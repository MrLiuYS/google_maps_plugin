...
Downloaded by pub (not CocoaPods).
  ...
  s.source           = { :http => 'https://github.com/flutter/packages/tree/main/packages/google_maps_plugin/google_maps_plugin/ios' }
  s.documentation_url = 'https://pub.dev/packages/google_maps_plugin'
  s.source_files = 'Classes/**/*.{h,m}'
  s.public_header_files = 'Classes/**/*.h'
  s.module_map = 'Classes/google_maps_plugin.modulemap'
